...
class TripNavigationBar extends StatefulWidget {
  int selectedIndex;
  Function onItemTapped;
  TripNavigationBar(
      {@required this.selectedIndex, @required this.onItemTapped});
  ...
  @override
  _TripNavigationBarState createState() => _TripNavigationBarState();
}

class _TripNavigationBarState extends State<TripNavigationBar> {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(left: 60, right: 60, bottom: 20),
